...
int main() {
	...
	CU_pSuite suite = CU_add_suite("Card and Stack", NULL, NULL);
	CU_ADD_TEST(suite, add_cards_on_empty_test);
	CU_ADD_TEST(suite, add_cards_under_empty_test);
	CU_ADD_TEST(suite, append_stack_on_tail_test);
	CU_ADD_TEST(suite, shuffle_test);
	CU_ADD_TEST(suite, pop_from_top_to_top_test);
	CU_ADD_TEST(suite, pop_from_top_to_top_on_empty_test);
